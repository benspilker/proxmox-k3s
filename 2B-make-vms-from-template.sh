...
ADMIN_VM_IP="192.168.100.6/24"

TEST_K3S_01_IP="192.168.100.76/24"
TEST_K3S_02_IP="192.168.100.92/24"
TEST_K3S_03_IP="192.168.100.93/24"

TEST_K3S_04_IP="192.168.100.94/24"
TEST_K3S_05_IP="192.168.100.95/24"

TEST_LONGHORN01_IP="192.168.100.3/24"
TEST_LONGHORN02_IP="192.168.100.4/24"
TEST_LONGHORN03_IP="192.168.100.5/24"
...
create_vm 200 "ubuntu-admin-vm" 2048 2 "$ADMIN_VM_IP,gw=$ROUTER_GATEWAY"


# Step 2B.3, VM's 201-203 will be K3S controllers
create_vm 201 "test-k3s-01" 4096 2 "$TEST_K3S_01_IP,gw=$ROUTER_GATEWAY"
create_vm 202 "test-k3s-02" 4096 2 "$TEST_K3S_02_IP,gw=$ROUTER_GATEWAY"
create_vm 203 "test-k3s-03" 4096 2 "$TEST_K3S_03_IP,gw=$ROUTER_GATEWAY"


# Step 2B.4, VM's 204 and 205 will be workload VMs
create_vm 204 "test-k3s-04" 6144 4 "$TEST_K3S_04_IP,gw=$ROUTER_GATEWAY"
...
create_vm 205 "test-k3s-05" 6144 4 "$TEST_K3S_05_IP,gw=$ROUTER_GATEWAY"
...
create_vm 211 "test-longhorn01" 4096 2 "$TEST_LONGHORN01_IP,gw=$ROUTER_GATEWAY"
...
create_vm 212 "test-longhorn02" 4096 2 "$TEST_LONGHORN02_IP,gw=$ROUTER_GATEWAY"
...
create_vm 213 "test-longhorn03" 4096 2 "$TEST_LONGHORN03_IP,gw=$ROUTER_GATEWAY"
